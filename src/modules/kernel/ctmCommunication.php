...
class CTM_Communication extends CTM_Framework
{
	...
	*/
	private static function checkLibrary($library, $settings = array())
	{
		...
		{
			if(file_exists(self::LibGetRealPath(self::COMMUNICATION_LIB_FOLDER).$lib.".lib.php"))
			{
				$library = "Communication_".$library;
				require_once(self::LibGetRealPath(self::COMMUNICATION_LIB_FOLDER).$lib.".lib.php");
