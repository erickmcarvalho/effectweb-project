...
class CTM_FileManage extends CTM_Framework
{
	...
	*/
	private static function checkLibrary($library, $settings = array())
	{
		...
		{
			if(file_exists(self::LibGetRealPath(self::FILE_MANAGEMENT_LIB_FOLDER).$lib.".lib.php"))
			{
				$library = "FileManagement_".$library;
				require_once(self::LibGetRealPath(self::FILE_MANAGEMENT_LIB_FOLDER).$lib.".lib.php");
