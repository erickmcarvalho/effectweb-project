...
class CTM_MuOnline extends CTM_Framework
{
	...
	*/
	private static function checkLibrary($library, $settings = array())
	{
		...
		{
			if(file_exists(self::LibGetRealPath(self::MUONLINE_LIB_FOLDER).$lib.".lib.php"))
			{
				$library = "MuOnline_".$library;
				require_once(self::LibGetRealPath(self::MUONLINE_LIB_FOLDER).$lib.".lib.php");
