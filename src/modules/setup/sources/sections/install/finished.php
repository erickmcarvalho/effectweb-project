...
class Install_Finished extends CTM_Command
{
	/**
	 *	Class construct
	 *
	...
	*/
	public function run()
	{
		...
		$new_file .= "\$installation['old_version']		= 0x".str_pad(strtoupper(dechex($installation['old_version'])), 4, 0, STR_PAD_RIGHT).";\n";
		$new_file .= "\$installation['last_installation']	= 0x".strtoupper(dechex(time())).";\n";
		$new_file .= "\$installation['last_update']		= 0x".strtoupper(dechex($installation['last_update'])).";";
